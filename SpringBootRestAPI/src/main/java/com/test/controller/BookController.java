...
public class BookController {
	...
	@PostMapping(value = "/create", consumes = "application/json")  // api consumes and we are posting.
	public ResponseEntity<Book> createBook(@RequestBody Book book) // HTTP message converter converting meta format(from frontend or swagger or postman) to java object
	{
	...
	@GetMapping(value = "/list", produces = "application/json")  // api producing and we are getting that value
