...
public class MLATeamDao {
	...
	public int saveMLATeam(MLATeam  obj) {
		...
		String sql = "insert into mlateam value(" +obj.getId()+", '"+obj.getName()+"', '"+obj.getSkill()+"', '"+obj.getManager()+"')";
		return jdbcTemplate.update(sql);
	}
	
	public int updateMLATeam(MLATeam obj) {
		String sql = "update mlateam set e_name = '"+obj.getName()+"', e_skill = '"+obj.getSkill()+"', t_manager = '"+obj.getManager()+"' where id = "
				+obj.getId()+" ";
		return jdbcTemplate.update(sql);
	}
